...
/**
 * Custom class designed to generated default styling for recycler views
 *
 * In this case it generates padding on all sides of the item in the recycler view list
 */
